        ...
        + g.panel.row.withPanels([
          ...
          g.panel.stateTimeline.new('vdbench (IOPS)')
            ...
            + g.panel.stateTimeline.withTargets([
              ...
              elasticsearch.withAlias('Total {{term kind.keyword}} %CPU [240 cores]: {{term scale}} vms')
