      ...
      g.panel.row.new("Hammerdb")
        ...
        + g.panel.row.withPanels([
          ...
          g.panel.stateTimeline.new('HammerDB KTPM')
            + stateTimeline.withDescription("postgres: shared_buffers = 4096MB          mariadb: innodb_buffer_pool_size = 8192MB")
